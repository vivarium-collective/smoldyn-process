...
class SmoldynProcess(Process):
    ...
    def update(self, state: Dict, interval: int) -> Dict:
        ...
        for index, mol_id in enumerate(self.molecule_ids):
            ...
            molecule_coordinates = single_molecule_data[3:6]
            all_molecule_coordinates.append(molecule_coordinates)
            simulation_state['molecules'][mol_id] = {
                'coordinates': molecule_coordinates,
        ...
        simularium_file_dir = os.getcwd()
        interval_simularium_filename = str(datetime.utcnow())\
        ...
        generate_simularium_file(
            ...
            timestep=self.simulation.dt,
            file_save_name=simularium_fp
        )
